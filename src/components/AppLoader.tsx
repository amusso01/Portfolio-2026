 ...
 *    then children (the app) mount so the Hero can run its animations.
 *
...
/** Runs a staged intro, then reveals the app only after the loader exits. */
export function AppLoader({ children }: AppLoaderProps) {
	...
	// When fonts loaded and hold elapsed, start exit; after EXIT_DURATION_MS mount the app.
	useEffect(() => {
	...
	// Full-screen black overlay; ellipse clip retreats topward on exit (bottom to top reveal).
	return (
		<div
